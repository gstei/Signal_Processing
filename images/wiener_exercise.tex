...
\draw
    ...
    node [ampl, below of=suma1,right of=suma1] (gain) {\Large$\alpha$}
    ...
    node [right of=suma2,bullet,label=above:{$y[n]$}] (point2) {}
    node [right of=point2, block] (wiener) {$z^{-1}$}
    node [ampl, below of=point2,shape border rotate=180] (wiener_0) {\Large$w_0$}
    node [ampl, below of=wiener,right of=wiener,shape border rotate=180] (wiener_1) {\Large$w_1$}
